package Note0614_Array.ArrayTest08;
/*
    关于一维数组的扩容。
...
public class ArrayTest08 {
    public static void main(String[] args) {
        ...
        /*for (int i = 0; i < dest.length; i++) {
            System.out.println(dest[i]);//0 0 0 11 22 0 0 0 0...
        }*/
        System.arraycopy(src,0,dest,0,src.length);
        for (int i = 0; i < dest.length; i++) {
            System.out.println(dest[i]);//全部拷贝
        }

        String[] strs={"hello","world","study","oracle","mysql","jdbc"};
