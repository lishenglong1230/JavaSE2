package Note0614_Array.ArrayTest05;
/*
...
public class ArrayTest05 {
    ...
    public static void main(String[] args) {
        ...
        //那么这个时候JVM会自动将abc def xyz用过空格的方式进行分离，分离完成之后，自动放到String[] args数组当中。
        //所以main方法上面的String[] args数组主要是用来接收用户输入参数的。
        //把abc def xyz 转换成字符串数组：{"abc","def","xyz"}
        //遍历数组 遍历控制台写的数组 Run -->Edit Configurations --> Program arguments
