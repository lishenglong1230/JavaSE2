package Note0718_enum;//标识符，关键字不能做标识符。enum是关键字。
/*
...
public class EnumTest01 {
    public static void main(String[] args) {
        ...
        */
        ...
        System.out.println(success?"计算成功":"计算失败");//计算成功
    }
...
/*    public static int divide(int a,int b){
    ...
    //既然最后的结果只是成功个失败，最好使用布尔类型。因为布尔类型true和false正好可以表示两种不同的状态。
    ...
    /*
    思考：以上的这个方法设计没毛病。返回true和false表示两种情况，
