...
HashMap集合：
    ...
    3、HashMap集合底层的源代码：
        public class HashMap{
            ...
            static class Node<K,V>{
                final int hash;//哈希表（哈希值（哈希值是key的hashCode()方法的执行结果。hash值通过哈希函数/算法，可以转换成存储成数组的下标））
    ...
    5、HashMap集合的key部分特点：
        ...
        不可重复是这么保证的？equals方法里保证HashMap集合的key不可重复。
        如果key重复了。value会覆盖。
    ...
    6、哈希表HashMap使用不当时无法发挥性能！
        ...
        什么是散列分布均匀？
            ...
            是散列分布均匀的。
        假设将所有的hashCode()方法返回值都设定为不一样的值，可以吗，有什么问题吗？
    ...
    9、JDK8之后，如果哈希表单向链表中元素超过8个，单向链表这种数据结构会变成红黑树数据结构。
...
public class HashMapTest01 {
    public static void main(String[] args) {
        ...
        for (Map.Entry<Integer,String> entry:set){
            //验证结果：Hashmap集合“key部分”元素：无序不可重复
